package streaming.api.environment;

import annotation.Internal;
import annotation.Public;
import annotation.PublicEvolving;
import api.common.ExecutionConfig;
import api.common.JobExecutionResult;
import api.common.functions.InvalidTypesException;
import api.common.typeinfo.TypeInformation;
import api.dag.Transformation;
import api.java.typeutils.MissingTypeInfo;
import api.java.typeutils.ResultTypeQueryable;
import api.java.typeutils.TypeExtractor;
import configuration.Configuration;
import configuration.ReadableConfig;
import core.execution.*;
import streaming.api.datastream.DataStreamSource;
import streaming.api.functions.source.FromElementsFunction;
import streaming.api.functions.source.ParallelSourceFunction;
import streaming.api.functions.source.SourceFunction;
import streaming.api.graph.StreamGraph;
import streaming.api.graph.StreamGraphGenerator;

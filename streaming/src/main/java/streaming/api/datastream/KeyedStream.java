...
import api.common.InvalidProgramException;
import api.common.functions.ReduceFunction;
import api.common.typeinfo.TypeInformation;
import api.java.functions.KeySelector;
import api.java.typeutils.TupleTypeInfoBase;
import api.java.typeutils.TypeExtractor;
import streaming.api.functions.sink.SinkFunction;
import streaming.api.graph.StreamGraphGenerator;
import streaming.api.operators.StreamGroupedReduce;
import streaming.api.operators.StreamOperatorFactory;
import streaming.api.transformations.OneInputTransformation;
import streaming.api.transformations.PartitionTransformation;
import streaming.runtime.partitioner.KeyGroupStreamPartitioner;

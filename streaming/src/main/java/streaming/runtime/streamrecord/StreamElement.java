...
package streaming.runtime.streamrecord;

import annotation.Internal;
import streaming.api.watermark.Watermark;
import streaming.runtime.streamstatus.StreamStatus;
...
public abstract class StreamElement {
	 ...
	 * @throws ClassCastException Thrown, if this element is actually not a Stream Status.
	 */
